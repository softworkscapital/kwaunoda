  ...
  <Text style={{ textAlign: 'right', flex: 1, textAlign: 'right',fontSize: 12, }}>Forgot Password</Text> 
    ...
    {/* <View style={{ width: 1, height: 20, backgroundColor: '#ccc', marginHorizontal: 10 }} /> */}
      ...
      <TouchableOpacity
          ...
          >
          <Text style={{ alignSelf: "center", fontSize: 12, color: 'black', paddingTop: 20, }}>
          Create Account
        </Text>
          </TouchableOpacity>
      <View style={{ bottom: 0, backgroundColor: "#002966", paddingTop: 15, paddingBottom: 15, marginTop: 10, }}>
