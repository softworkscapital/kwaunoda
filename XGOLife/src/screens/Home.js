 ...
 // Dependency on navigated
    ...
    try {
      ...
      if (filteredUserTrips.length > 0) {
        ...
        tripsWithDrivers.forEach((trip) => {
          if (trip.driver_status === "Ended" && trip.weight === 0 &&trip.status === "InTransit") {
  ...
  return (
    ...
    {trip.status !== "New Order" && trip.driver && (
                ...
                {/* Trip Details (if any) */}
                {trip.deliveray_details && trip.deliveray_details.length > 0 && (
                  <View style={styles.deliveryDetailsContainer}>
                    <Text style={styles.deliveryDetailsLabel}>Details:</Text>
                    <Text style={styles.deliveryDetailsText} numberOfLines={2}>
                ...
                <View style={styles.actionButtonsContainer}>
                  {trip.status === "New Order" ? (
                    ...
                    trip.weight === 0 && (  <TouchableOpacity
                      style={styles.endButton}
                      onPress={() => endtrip(trip)}
                    >
                      <FontAwesome name="flag-checkered" size={16} color="white" />
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("TripTrack", { trip })}
                  >
                    <FontAwesome name="map-marker-alt" size={16} color="white" />
