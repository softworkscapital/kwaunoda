  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={toggleDropdown} style={styles.dropdownButton}>
        <Text style={styles.dropdownText}>{currentCat || 'Select Category'}</Text>
        <FontAwesome name={dropdownVisible ? 'chevron-up' : 'chevron-down'} size={15} color='gray' />
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  dropdownContainer: {
    ...
    zIndex: 1,    // to ensure dropdown is on top
  },
  categoryButton: {
    padding: 10,
  },
