...
const SignUpCustomer = () => {
    ...
    const handleSignUp = async () => {
        ...
        try {
            await AsyncStorage.setItem('customerDetailsC0', JSON.stringify(customerDetails));
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView>
                <View style={styles.formContainer}>
                    <View>
                        <Text style={{ alignSelf: 'center', fontSize: 14, marginBottom: 10 }}>Sign Up As Customer</Text>
                    </View>
