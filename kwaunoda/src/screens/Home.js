...
const Home = () => {
  ...
  const [userDetails, setUserDetails] = useState({ name: '', surname: '', usertype: '' });
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      ...
      try {
        if (customerid) {
          const response = await fetch(`${APILINK}/customerdetails/${customerid}`, {
            method: 'GET',
            headers: {
  ...
  return (
    ...
    >
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.viewTop}>
          ...
          <View style={styles.nameContainer}>
            <Text style={styles.firstName}>{userDetails.name} {userDetails.surname}</Text>
            <Text style={styles.surname}>{userDetails.usertype}</Text>
          </View>
          <TouchableOpacity style={styles.menuIcon} onPress={toggleNotificationModal}>
          ...
          <TouchableOpacity style={[styles.menuIcon, { marginLeft: 15 }]} onPress={toggleModal}>
      ...
      <View style={styles.fixedCard}>
        ...
        <TouchableOpacity style={styles.btnButton1} onPress={redirectNewDelivery}>
