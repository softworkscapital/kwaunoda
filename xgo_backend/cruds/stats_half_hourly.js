...
let crudsObj = {};
crudsObj.postHalfHourlyStatistic = (application_statistic_id) => {
    let datefor = "";
    let kms_billed = "";
    let customers_count = "";
    let drivers_count = "";
                                                  ...
                                                  pool.query(
                                                    ...
                                                    `,
                                                                                                                (
                                                                                                                  ...
                                                                                                                  pool.query(
                                                                                                                    `INSERT INTO application_statistics_half_hourly (
                                                                  datefor,
                                                                  kms_billed,
                                                                  customers_count,
                                                                  drivers_count,
...
crudsObj.getHalfHourlyStatisticsByDateRange = (datefrom, dateto) => {
  return new Promise((resolve, reject) => {
    pool.query(
      "SELECT * FROM application_statistics_half_hourly WHERE datefor BETWEEN ? AND ?",
      [datefrom, dateto],
      (err, results) => {
        if (err) {
          return reject(err);
...
crudsObj.getHalfHourlyStatisticById = (application_statistic_id) => {
  return new Promise((resolve, reject) => {
    pool.query(
      "SELECT * FROM application_statistics_half_hourly WHERE application_statistic_id = ?",
...
crudsObj.updateHalfHourlyStatistic = (application_statistic_id, updatedValues) => {
  const {
    datefor,
    kms_billed,
    customers_count,
  ...
  return new Promise((resolve, reject) => {
    pool.query(
      `UPDATE application_statistics_half_hourly SET 
              datefor =?,
              kms_billed =?,
              customers_count =?,
              drivers_count =?,
...
crudsObj.deleteHalfHourlyStatistic = (id) => {
  return new Promise((resolve, reject) => {
    pool.query(
      "DELETE FROM application_statistics_half_hourly WHERE application_statistic_id = ?",
      [id],
      (err, results) => {
        if (err) {
          return reject(err);
