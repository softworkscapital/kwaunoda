            ...
            <ScrollView contentContainerStyle={styles.scrollContainer}>
                <View style={styles.profileContainer}>
                    ...
                    <View style={{ marginLeft: 20 }}>
                        ...
                        <Text style={{ fontSize: 16, fontWeight: '800' }}>{symbol} {cost} </Text>
                        <Text style={{ fontSize: 18, fontWeight: 'faint' }}>Pay using {using}</Text>
                    </View>
                </View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 30 }}>
                    <TouchableOpacity style={[styles.btnSignUp, { marginTop: 5 }]}>
                        <Text style={styles.txtSignUp} onPress={Accept}>Accept</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.btnSignUp, { marginTop: 5 }]}>
