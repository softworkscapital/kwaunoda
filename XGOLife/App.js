...
import TripTrack2 from "./src/screens/TripTrack2.js";
    ...
    <ToastWrapper>
      <NavigationContainer>
        <Stack.Navigator screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen
            name="CustomerNewDelivery"
            component={CustomerNewDelivery}
          />
          <Stack.Screen name="DeliveryMap" component={DeliveryMap} />
          <Stack.Screen name="DriverChat" component={DriverChat} />
          <Stack.Screen name="TripTrack" component={TripTrack2} />
          <Stack.Screen name="CustomerChat" component={CustomerChat} />
          <Stack.Screen name="Wallet" component={Wallet} />
          <Stack.Screen
            name="CustomerAdminChat"
            component={CustomerAdminChat}
          />
