...
const InTransitTrip = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <WebView
        source={{
          uri: `https://xgolifedash.softworkscapital.com/Director?startLat=${OntripData.origin_location_lat}&startLng=${OntripData.origin_location_long}&endLat=${OntripData.destination_lat}&endLng=${OntripData.destination_long}`,
        }}
