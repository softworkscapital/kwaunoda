  ...
  const handleNext = async () => {
    ...
    try {
      ...
      const driver = {
        ...
        email: email.trim(),
        password: md5Hash,
        profilePic: driverDetails.profilePicPath ? driverDetails.profilePicPath.trim() : "",
        id_image: driverDetails.idPicPath ? driverDetails.idPicPath.trim() : "",
        number_plate_image: driverDetails.platePicPath ? driverDetails.platePicPath.trim() : "",
        driver_license_image: driverDetails.driversLicensePicPath ? driverDetails.driversLicensePicPath.trim() : "",
        ...
        vehicle_license_image:driverDetails.vehicleLicensePicPath,
        vehicle_img1:driverDetails.vehicleImage1Path,
        vehicle_img2:driverDetails.vehicleImage2Path,
        vehicle_img3:driverDetails.vehicleImage3Path,
        number_of_passengers: driverDetails.vehicleCount,
      };
